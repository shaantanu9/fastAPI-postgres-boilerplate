...
Revision ID: 9f1a8c42d78c
Revises: e0c1defd32bc
Create Date: 2025-06-03 13:13:51.296245
...
revision: str = '9f1a8c42d78c'
down_revision: Union[str, None] = 'e0c1defd32bc'
...
def upgrade() -> None:
    ...
    op.add_column('product_tests', sa.Column('status', sa.String(length=255), nullable=True))
