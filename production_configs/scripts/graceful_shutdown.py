...
class GracefulShutdownManager:
    ...
    async def shutdown(self):
        ...
        try:
            ...
            logger.warning(f"Graceful shutdown timed out after {self.shutdown_timeout}s. Forcing exit.")
    ...
    async def _wait_for_tasks(self):
        ...
        try:
            ...
            logger.warning("Background tasks didn't complete within timeout, cancelling...")
    ...
    async def _drain_connections(self):
        ...
        if self.active_connections:
            logger.warning(f"Force closing {len(self.active_connections)} remaining connections")
