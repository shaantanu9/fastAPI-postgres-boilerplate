# Gunicorn Configuration for Production FastAPI SaaS
...
def on_starting(server) -> None:
    ...
    server.log.info("Starting SaaS application...")


def on_reload(server) -> None:
    """Called to recycle workers during a reload via SIGHUP."""
    server.log.info("Reloading SaaS application...")


def when_ready(server) -> None:
    """Called just after the server is started."""
    server.log.info("SaaS application ready to serve requests")
...
def on_exit(server) -> None:
    ...
    server.log.info("Shutting down SaaS application...")
