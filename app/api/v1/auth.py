...
async def register_user(
    user_create: UserCreate, request: Request, db: Annotated[AsyncSession, Depends(get_db)],
):
...
async def login(
    login_data: LoginRequest, request: Request, db: Annotated[AsyncSession, Depends(get_db)],
):
...
async def get_security_events(
    ...
    try:
        return await enhanced_user_service.get_security_events(
