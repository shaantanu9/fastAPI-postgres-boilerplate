...
async def create_user(user_create: UserCreate, db: Annotated[AsyncSession, Depends(get_db)]):
...
async def update_user(
    ...
    try:
        return await enhanced_user_service.update_user(db, user_id, user_update)
    except HTTPException:
        raise
    except Exception:
        raise HTTPException(
