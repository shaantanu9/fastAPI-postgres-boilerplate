...
from app.api.v1.endpoints.error_dashboard import router as error_dashboard_router
...
try:
    from app.api.v1.endpoints.procrastinate_admin import (
        router as procrastinate_admin_router,
    )
...
api_router.include_router(error_dashboard_router, tags=["Error Dashboard"])
api_router.include_router(user.router, prefix="/users", tags=["users"])
api_router.include_router(
    user_management.router, prefix="/user-management", tags=["user-management"],
)
api_router.include_router(
...
# Email service
api_router.include_router(
    email_integration.router, prefix="/email", tags=["email-service"],
)
...
api_router.include_router(
    procrastinate_tasks.router, prefix="/procrastinate", tags=["procrastinate-tasks"],
)
...
api_router.include_router(
    rate_limit_test.router, prefix="/test/rate-limit", tags=["rate-limit-tests"],
)
api_router.include_router(
    timeout_test_router, prefix="/test/timeout", tags=["timeout-tests"],
)
...
api_router.include_router(
    feature_flags_router, prefix="/features", tags=["feature-flags"],
)

# Notification preferences
api_router.include_router(
    notification_preferences.router, prefix="/notifications", tags=["notifications"],
)
...
api_router.include_router(
    procrastinate_test.router, prefix="/test-procrastinate", tags=["procrastinate-test"],
)
