...
from app.models.notification import (
    ...
    NotificationStatus, NotificationPriority, NotificationCategory,
    NotificationChannel
)
from app.utils.event_broadcaster import get_event_broadcaster, EventPayload
...
class NotificationService:
    ...
    async def _send_websocket_notification(self, notification: Notification) -> None:
        ...
        if not notification.tenant_id or not notification.user_id:
            logger.warning(f"Cannot send WebSocket notification without tenant and user ID")
            return
        ...
        logger.debug(f"Sent WebSocket notification {notification.id} to user {notification.user_id}")
