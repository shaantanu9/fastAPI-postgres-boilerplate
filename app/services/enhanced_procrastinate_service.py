...
class EnhancedProcrastinateService(EnhancedBaseService):
    ...
    def __init__(self, model_class: Type):
        ...
        self.procrastinate_manager: Optional[ProcrastinateManager] = None
    ...
    async def schedule_maintenance_tasks(
        ...
        return {
            ...
            "schedule_time": schedule_time.isoformat() if schedule_time else "immediate",
            "created_at": datetime.now().isoformat()
        }
    ...
    async def get_queue_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            concurrent_health = {
                "thread_executor_active": concurrent_manager.thread_executor is not None,
                "process_executor_active": concurrent_manager.process_executor is not None,
            }
