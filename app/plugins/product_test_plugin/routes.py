...
class ProductTestRoutes:
    ...
    def setup_routes(self):
        ...
        @self.router.post("/product_tests/", response_model=ProductTestResponse, tags=["ProductTest"])
        ...
        async def create_product_test(item: ProductTestCreate, request: Request):
            ...
            try:
                ...
                # Emit creation event
                self.emit_event("product_test_created", 
                              id=result.id, 
                              plugin="product_test_plugin")
        ...
        @self.router.get("/product_tests/", response_model=List[ProductTestResponse], tags=["ProductTest"])
        ...
        @self.router.get("/product_tests/{item_id}", response_model=ProductTestResponse, tags=["ProductTest"])
        @with_timeout(timeout_seconds=5.0)
        ...
        @self.router.put("/product_tests/{item_id}", response_model=ProductTestResponse, tags=["ProductTest"])
        @with_timeout(timeout_seconds=10.0)
        async def update_product_test(item_id: int, item: ProductTestUpdate, request: Request):
        ...
        @self.router.get("/product_tests/search/", response_model=List[ProductTestResponse], tags=["ProductTest"])
