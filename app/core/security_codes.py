...
class EnterpriseSecurityCodeService:
    ...
    async def verify_backup_code(self, user_id: str, code: str, db: AsyncSession) -> bool:
        """
    ...
    async def verify_backup_code_for_login(self, user_id: str, code: str, db: AsyncSession) -> bool:
        """
    ...
    async def verify_backup_code_for_password_reset(self, user_id: str, code: str, db: AsyncSession) -> bool:
        """
    ...
    async def generate_recovery_code(self, user_id: str, valid_hours: int = 24) -> str:
        ...
        logger.info(f"Generated recovery code for user {user_id}, expires in {valid_hours}h")
        return recovery_code

    async def verify_recovery_code(self, recovery_code: str) -> Optional[Dict[str, Any]]:
    ...
    async def revoke_all_codes(self, user_id: str, db: AsyncSession):
    ...
    async def get_user_code_status(self, user_id: str, db: AsyncSession) -> Dict[str, Any]:
