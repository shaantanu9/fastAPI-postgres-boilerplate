...
class PerformanceLogger:
    ...
    def log_database_query(self, query_type: str, table: str, duration: float) -> None:
...
class SecurityLogger:
    ...
    def log_login_attempt(
        self, username: str, success: bool, ip: str, user_agent: str | None = None,
    ) -> None:
        """Log login attempts."""
        self.logger.info(
    ...
    def log_permission_denied(self, user_id: str, resource: str, action: str, ip: str) -> None:
    ...
    def log_suspicious_activity(
        self, user_id: str, activity: str, details: dict[str, Any], ip: str,
    ) -> None:
...
def set_user_context(uid: str) -> None:
