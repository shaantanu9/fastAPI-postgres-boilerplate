#!/usr/bin/env python3
"""
TEST PLUGIN INITIALIZATION PROCESS TEST

PURPOSE:
    Test plugin initialization process
    
WHEN TO USE:
    When plugins are not initializing correctly
    
WHAT IT TESTS:
    Plugin loading, initialization, status
...
HOW TO RUN:
    python3 tests/plugins/test_plugin_init.py
