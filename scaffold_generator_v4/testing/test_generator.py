...
class TestGenerator:
    ...
    def _create_test_structure(self, config: TestConfig) -> None:
        """Create test directory structure."""
    ...
    def _generate_unit_tests(self, config: TestConfig) -> None:
...
'''
    ...
    def _generate_integration_tests(self, config: TestConfig) -> None:
...
'''
        ...
        (integration_dir / f"test_{config.plugin_name}_integration.py").write_text(
            integration_test,
        )

    def _generate_e2e_tests(self, config: TestConfig) -> None:
...
'''
    ...
    def _generate_load_tests(self, config: TestConfig) -> None:
        """Generate load tests."""
...
'''
    ...
    def _generate_test_config(self, config: TestConfig) -> None:
